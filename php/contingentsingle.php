...
<nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar">
    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form method="post" id="mainform" enctype="multipart/form-data" style="margin-top: 10px;" action="submitsevnt.php">
                    <div id="participants">
                    ...
                    <div class="form-group"><label for="name">Contingent Name<span class="imp"> *</span></label>
                        ...
                        echo "<select autofocus='' class='form-control' id='contingent-name' name='contingentname' placeholder='Name' required=''>";
                        ...
                        <div class="form-group name" ><label for="name">Contingent PoC Name<span class="imp"> *</span></label><input class="form-control item" type="name"  name="namein[]" required></div>
                        <div class="form-group email"  ><label for="email">Contingent PoC Email<span class="imp"> *</span></label><input class="form-control item" type="text"name="email[]" required></div>
                        <div class="form-group phone" ><label for="phone">Contingent PoC Phone<span class="imp"> *</span></label><input class="form-control item" type="text" name="phone[]" required></div> 
                        ...
                        <button class="btn btn-light btn-block border-primary" onclick="addmember()" id="add" style="color: rgb(4,115,227);">Add Members</button>
                        ...
                        <div class="form-group"><label class="event-title">Events</label>
                            ...
                            <div class="form-check"  style="display:none">
                                ...
                                <?php
                                    ...
                                    //echo "".$stockitup."";
                                    if($count>=18){
                                        echo "<input type='checkbox'name='check_doomanddestiny' disabled class='form-check-input' id='DoomAndDestiny' onclick='onlyOne(this)'>";
                                    }
                                    else{
                                        echo " <input type='checkbox' name='check_doomanddestiny' class='form-check-input' id='DoomAndDestiny'onclick='onlyOne(this)' >";
                                    }
                            ...
                            <div class="form-check"  style="display:none">
                                ...
                                <?php
                                    ...
                                    //echo "".$stockitup."";
                                    if($count>=24){
                                        echo "<input type='checkbox'name='check_arthanomicsassembly' disabled class='form-check-input' id='ArthanomicsAssembly' onclick='onlyOne(this)'>";
                                    }
                                    else{
                                        echo " <input type='checkbox' name='check_arthanomicsassembly' class='form-check-input' id='ArthanomicsAssembly' onclick='onlyOne(this)'>";
                                    }
                            ...
                            <div class="form-check"  style="display:none">
                                ...
                                <?php
                                    ...
                                    //echo "".$stockitup."";
                                    if($count>=50){
                                        echo "<input type='checkbox'name='check_marketingmaestros' disabled class='form-check-input' id='MarketingMaestros' onclick='onlyOne(this)'>";
                                    }
                                    else{
                                        echo " <input type='checkbox' name='check_marketingmaestros' class='form-check-input' id='MarketingMaestros' onclick='onlyOne(this)'>";
                                    }
                            ...
                            <div class="form-check"  style="display:none">
                                ...
                                <?php
                                    ...
                                    //echo "".$stockitup."";
                                    if($count>=32){
                                        echo "<input type='checkbox'name='check_policypandemonium' disabled class='form-check-input' id='PolicyPandemonium' onclick='onlyOne(this)'>";
                                    }
                                    else{
                                        echo " <input type='checkbox' name='check_policypandemonium' class='form-check-input' id='PolicyPandemonium' onclick='onlyOne(this)'>";
                                    }
                            ...
                            <div class="form-check"  style="display:none">
                                ...
                                <?php
                                    ...
                                    //echo "".$stockitup."";
                                    if($count>=24){
                                        echo "<input type='checkbox'name='check_journalisminjeopardy' disabled class='form-check-input' id='JournalisminJeopardy' onclick='onlyOne(this)'>";
                                    }
                                    else{
                                        echo " <input type='checkbox' name='check_journalisminjeopardy' class='form-check-input' id='JournalisminJeopardy' onclick='onlyOne(this)'>";
                                    }
                            ...
                            <div class="form-check"  style="display:none">
                                ...
                                <?php
                                    ...
                                    //echo "".$stockitup."";
                                    if($count>=40){
                                        echo "<input type='checkbox'name='check_tycoonsoftomorrow' disabled class='form-check-input' id='TycoonsofTomorrow' onclick='onlyOne(this)'>";
                                    }
                                    else{
                                        echo " <input type='checkbox' name='check_tycoonsoftomorrow' class='form-check-input' id='TycoonsofTomorrow' onclick='onlyOne(this)'>";
                                    }
                            ...
                            <label style="margin-top:10px ;font-weight:500; font-family:sans-serif;" >Note:
                            <li>
                            If you are unable to see a particular event in this list, the capacity for that event is full.
                            </li>
                            <li>
                            If you wish to participate in more than one event, please fill the contingent registration multiple event form.
                            </li></label>
    ...
    <script src="assets/js/contingentsingle.js"></script>
